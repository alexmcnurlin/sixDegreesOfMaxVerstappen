...
test("can see race details", async ({ page }) => {
  ...
  await expect(page.locator("#driver-2-accordion-details")).toHaveText(
    "Max Verstappen was teammates with Carlos Sainz Jr.from: 2015 startto:2016 end"
  );
});
...
test("can see multple links", async ({ page }) => {
  ...
  await expect(page.locator("#driver-3-accordion-details")).toHaveText(
    "Carlos Sainz Jr. was teammates with Charles Leclercfrom: 1234 startto:4321 end"
  );
});
...
test("can see multiple race ranges", async ({ page }) => {
  ...
  await expect(page.locator("#driver-2-accordion-details")).toHaveText(
    "Max Verstappen was teammates with Carlos Sainz Jr.from: 1234 start1to:4321 end1from: 1235 start2to:5321 end2"
  );
});
