...
* When the server starts, load the data in the above JSON file and compute a list of teammate pairings using the Floyd-Warshaw algorithm, modified to store the path for each route.
